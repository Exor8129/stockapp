...
import { Badge, Modal, Button, Select, Input, DatePicker, Card } from "antd";
...
useEffect(() => {
  ...
  const handleItemChange = async (value) => {
    ...
    setTeamName("New Entry"); // Reset teamName when changing item
    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      {/* Popup Modal  */}
        ...
        <Modal
          ...
          width={800}
        >
      <Badge.Ribbon text={teamName} color="blue" >

            <Card>
          <p className="mb-4">Hello! Welcome to your dashboard.</p>
      ...
      <h1 className="text-2xl font-bold mb-4">
        Welcome {user === "team1" ? "Team 1 User" : "Team 2 User"}!
      </h1>
      {/* Buttons */}
